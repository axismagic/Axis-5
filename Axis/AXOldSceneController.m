...
@implementation AXOldSceneController
...
+ (AXOldSceneController*)sharedSceneController {
    static AXOldSceneController *sharedSceneController;
    @synchronized(self) {
        if (!sharedSceneController)
            sharedSceneController = [[AXOldSceneController alloc] init];
    }
